...
tf.app.flags.DEFINE_integer("in_vocab_size", 4500, "input vocabulary size.")
tf.app.flags.DEFINE_integer("out_vocab_size", 4500, "output vocabulary size.")
...
def create_model(session, forward_only):
  ...
  #print(gfile.Exists(ckpt.model_checkpoint_path))
